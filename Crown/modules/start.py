...
from Crown import app, boot, botname, botusername
from Crown.database.cleanmode import cleanmode_off, cleanmode_on, is_cleanmode_on
from Crown.helpers import get_readable_time, put_cleanmode, settings_markup, RANDOM, HELP_TEXT
    ...
    upl = InlineKeyboardMarkup(
        [
            [
                ...
                InlineKeyboardButton (
                    text="🤴Owner",
                    url=f"https://t.me/little_little_hackur",
                ), 
            ]
        ]
    )
